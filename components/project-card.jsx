...
export default function ProjectCard({ project, isActive }) {
  ...
  return (
    <div ref={cardRef} className={`project-card min-h-screen py-24 px-8 md:px-16 ${isActive ? "active" : ""} flex`}>
      <div className="ml-auto w-full md:w-3/5 lg:w-1/2" ref={contentRef}>
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap gap-3 mt-12">
            ...
            <span className={`border border-gray-700 rounded-full px-5 py-2 text-sm ml-2 ${inter.className}`}>
              {project.year}
            </span>
          </div>
        </div>
