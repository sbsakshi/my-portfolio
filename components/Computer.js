    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          ...
          position={[0.12706, 1.83121, 0.51088]}
          rotation={[1.57094, -0.0046, 0.03064]}
          scale={[0.66063, 0.60835, 0.40093]}>
            <meshBasicMaterial map={txt}/>
            </mesh>
        <group
          name="RootNode"
          position={[0, 1.09284, 0]}
          rotation={[-Math.PI / 2, 0, -0.03285]}
          scale={0.04457}>
          <group
            name="Screen001"
            position={[5.6578, 1.643, 0.81176]}
            rotation={[Math.PI / 2, 0, 0]}
            scale={[0.92321, 0.85511, 0.85511]}
          />
          <group
            name="Screen002"
            position={[5.6578, 1.644, 0.81176]}
            rotation={[Math.PI / 2, 0, 0]}
            scale={[0.92321, 0.85511, 0.85511]}
          />
          <group
          ...
          <group
            ...
            position={[16.08861, -3.4705, -14.4949]}
            rotation={[Math.PI / 2, 0, 0]}
            scale={0.96274}
          />
          <group
            name="Tower-light-008"
            position={[15.15511, -3.4705, -14.4949]}
            rotation={[Math.PI / 2, 0, 0]}
            scale={0.96274}
          />
        </group>
        <group
          ...
          position={[0.26559, 1.13238, 0.0509]}
          rotation={[0, -0.03285, 0]}
          scale={[0.0419, 0.04543, 0.04543]}>
          <mesh
